...
基于 [LitServe](https://github.com/Lightning-AI/litserve) 和 [RapidOCR](https://github.com/RapidAI/RapidOCR) 的高性能 OCR 推理服务，为 [liteparse](https://github.com/run-llama/liteparse) 提供文档文字识别能力。
